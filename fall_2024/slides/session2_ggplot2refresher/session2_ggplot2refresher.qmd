...
-   [Four types of EDA]{style="color:gray;"}
...
![Source: https://datavizproject.com/data-type/alluvial-diagram/](images/alluvial.png){fig-align="center"}

## Sankey diagrams

Flow diagram - width of the area is proportional to flow amount

![Source: https://datavizproject.com/data-type/sankey-diagram/](images/sankey.png){fig-align="center"}
...
Add example of automating the statistics 