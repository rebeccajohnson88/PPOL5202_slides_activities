...
- Not going to review all of them--- instead, focus on two, commonly-used ones:
    - Confusion matrix: refresher on the `square area chart` plot
    - ROC Curve 
...
## Visualize using square area chart
...
ggplot(all_predictions, aes(x = predict_prob,
                            group = true_class,
                            fill = true_class)) +
...
ggplot(roc_long, aes(x = thresholds, y = value,
                   group = group, 
                   color = group)) +
  geom_path() +
